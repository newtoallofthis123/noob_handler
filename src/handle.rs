    ...
    match option.as_str() {
        ...
        "Edit" => {
            ...
            if confirmation {
                ...
                utils::copy(
                    format!("https://noobscience.rocks/quips/{}", edited_page.hash).as_str(),
                );
    ...
    match option.as_str() {
        ...
        "Edit" => {
            ...
            if confirmation {
                ...
                utils::copy(
                    format!("https://noobscience.rocks/code/{}", edited_code.hash).as_str(),
                );
                bunt::println!("Copied URL to clipboard");
            } else {
                bunt::println!("{$red}Aborted{/$}");
